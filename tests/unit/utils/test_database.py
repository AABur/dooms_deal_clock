...
class TestDatabaseModels:
    ...
    def test_clock_update_model_attributes(self):
        ...
        expected_columns = [
            'id', 'time', 'description', 'raw_message', 
            'message_id', 'created_at', 'updated_at', 'is_active'
        ]
    ...
    def test_parsed_message_model_attributes(self):
        ...
        expected_columns = [
            'id', 'message_id', 'raw_text', 
            'parsed_successfully', 'error_message', 'processed_at'
        ]
    ...
    def test_models_inherit_from_base(self):
        ...
        from app.utils.database import ClockUpdate, ParsedMessage, Base
